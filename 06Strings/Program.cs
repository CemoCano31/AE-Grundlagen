namespace _06Strings
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string text = Console.ReadLine(); // wir speichern einen Text in String "text" über die Konsole mit .ReadLine()
                                                                // Length benutzen um die Anzahk an Zeichen zu erhalten und ziehen
                                                                // 1 ab um den richtigen Index für das letzte Zeichen zu erhalten,
                                                                // da wir bei 0 anfangen zu zählen.
          /*  Console.WriteLine(letztesZeichenVonText)*/;//Wir geben den entsprechenden Char in der Konsole aus 
                                                         //Console.WriteLine("Bitte geben Sie Ihr Postleitzahl ein");

            //String pzl = Console.ReadLine();

            //char ersteZahl = pzl[0];
            ...
            //        case '2':
            //            Console.WriteLine("Nordeutschland");
            //            break;
            ...
            //            break;
            //        default:
            //            Console.WriteLine("die  PLZ nicht verarbeitet werden .");
            //            break;
            ...
            //else
            //{
            //    Console.WriteLine("Bitte geben Sie Ihr Postleitzahl im richtigen Form ein!!!");
            //}
            //Aufgabe :
            ...
            //Console.Write("Geben Sie die getrunkene Biermenge in Litern an: ");
            //    double bierMenge = Convert.ToDouble(Console.ReadLine()) * 1000; // Umwandlung von Litern in Milliliter

            //    Console.Write("Geben Sie Ihr Gewicht in Kilogramm an: ");
            //    double gewicht = Convert.ToDouble(Console.ReadLine());

            //    // Berechnung des Reinalkohols in Gramm
            //    double reinalkohol = bierMenge * 0.05 * 0.8;

            //    // Berechnung des Blutalkoholgehalts in Promille
            //    double promille = reinalkohol / (0.65 * gewicht);

            //    // Ausgabe abhängig vom Promillewert
            //    if (promille <= 0.3)
            //    {
            ...
            {
                Console.WriteLine("Achtung! Hände weg vom Steuerr!");
            }
            ...
            {
                Console.WriteLine("Da ist etwas schief gelaufen! Etwa schon zu viel getrunken?");
            }
        }
